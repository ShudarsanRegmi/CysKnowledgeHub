            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start relative">
                ...
                <aside className={`w-full lg:w-[280px] shrink-0 space-y-6 ${isMobileFilterOpen ? 'block' : 'hidden lg:block'} lg:sticky lg:top-24`}>
                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-5 shadow-lg">
                        ...
                        {/* Minimum CTC Filter */}
                        <div>
                            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-200 mb-3">Minimum CTC (LPA)</h3>
                            <input
                                type="number"
                                placeholder="e.g. 15"
                                value={minCtc}
                                onChange={(e) => setMinCtc(e.target.value === '' ? '' : Number(e.target.value))}
                                className="bg-gray-50 dark:bg-gray-950 border border-gray-300 dark:border-gray-800 rounded-xl py-2 px-4 w-full text-sm focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all text-gray-900 dark:text-white placeholder:text-gray-400"
                            />
                        </div>
                ...
                <div className="flex-1 min-w-0">
                    <div className="mb-4 text-sm text-gray-500 font-medium px-1">
                        Showing <span className="text-gray-900 dark:text-white font-semibold">{filteredCompanies.length}</span> companies
                    </div>
