  ...
  const navItems = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { id: 'cyberstack',    label: 'Cyber Stack',       icon: Terminal },
      ],
    },
    {
                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl overflow-hidden z-50">
                    ...
                    {(role === 'author' || role === 'admin') && (
                      <button
                        ...
                        className="w-full flex items-center gap-2 px-4 py-3 text-sm text-cyan-600 dark:text-cyan-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                      >
                    ...
                    {role === 'admin' && (
                      <button
                        ...
                        className="w-full flex items-center gap-2 px-4 py-3 text-sm text-yellow-600 dark:text-yellow-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                      >
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-2 px-4 py-3 text-sm text-red-500 dark:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                    >
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600 dark:text-gray-400">
              <li><button onClick={() => setActiveTab('blogs')} className="hover:text-cyan-600 dark:hover:text-cyan-400">Security Blogs</button></li>
              <li><button onClick={() => setActiveTab('ctf')} className="hover:text-cyan-600 dark:hover:text-cyan-400">CTF</button></li>
              <li><button onClick={() => setActiveTab('roadmaps')} className="hover:text-cyan-600 dark:hover:text-cyan-400">Roadmaps</button></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold mb-4">Contribute</h4>
            <ul className="space-y-2 text-gray-600 dark:text-gray-400">
              <li><button className="hover:text-cyan-600 dark:hover:text-cyan-400">Submit Project</button></li>
              <li><button className="hover:text-cyan-600 dark:hover:text-cyan-400">Share Interview Exp</button></li>
              <li><button className="hover:text-cyan-600 dark:hover:text-cyan-400">CMS Login</button></li>
            </ul>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-4 mt-8 pt-8 border-t border-gray-200 dark:border-gray-800 text-center text-sm text-gray-500">
