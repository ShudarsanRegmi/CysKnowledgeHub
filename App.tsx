...
const Category = ({ title, certifications }: any) => {
          ...
          certifications={[
            {
              name: "CompTIA CySA+",
              level: "Intermediate",
              shortDesc: "Threat detection and incident response.",
              organization: "CompTIA",
              exam: "CS0-003 | 85 Questions",
              prep: "3 Months",
            ...
            },
            {
              name: "GIAC GCIH",
              level: "Advanced",
              shortDesc: "Hands-on incident handling certification.",
              organization: "GIAC",
          ...
          certifications={[
            {
              name: "CISM",
              level: "Advanced",
              shortDesc: "Information security management certification.",
              organization: "ISACA",
